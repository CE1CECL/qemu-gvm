...
uint32_t HELPER(stsi)(CPUS390XState *env, uint64_t a0, uint64_t r0, uint64_t r1)
{
    ...
    case STSI_R0_FC_LEVEL_1:
        if ((sel1 == 1) && (sel2 == 1)) {
            ...
            ebcdic_put(sysib.sysib_111.manuf, "2007            ", 16);
            /* same as machine type number in STORE CPU ID, but in EBCDIC */
            snprintf(type, ARRAY_SIZE(type), "%X", cpu->model->def->type);
            ebcdic_put(sysib.sysib_111.type, type, 4);
            /* model number (not stored in STORE CPU ID for z/Architecure) */
            ebcdic_put(sysib.sysib_111.model, "2007            ", 16);
            ebcdic_put(sysib.sysib_111.sequence, "2007            ", 16);
            ebcdic_put(sysib.sysib_111.plant, "2007", 4);
        } else if ((sel1 == 2) && (sel2 == 1)) {
            /* Basic Machine CPU */
            ebcdic_put(sysib.sysib_121.sequence, "2007200720072007", 16);
            ebcdic_put(sysib.sysib_121.plant, "2007", 4);
    ...
    case STSI_R0_FC_LEVEL_2:
        if ((sel1 == 2) && (sel2 == 1)) {
            /* LPAR CPU */
            ebcdic_put(sysib.sysib_221.sequence, "2007200720072007", 16);
            ebcdic_put(sysib.sysib_221.plant, "2007", 4);
            ...
            ebcdic_put(sysib.sysib_222.name, "2007    ", 8);
    ...
    case STSI_R0_FC_LEVEL_3:
        if ((sel1 == 2) && (sel2 == 2)) {
            ...
            ebcdic_put(sysib.sysib_322.vm[0].cpi, "2007/Linux       ", 16);
            ...
            if (qemu_name) {
                ...
                ebcdic_put(sysib.sysib_322.vm[0].name, "2007    ", 8);
                strcpy((char *)sysib.sysib_322.ext_names[0], "2007    ");
            }
